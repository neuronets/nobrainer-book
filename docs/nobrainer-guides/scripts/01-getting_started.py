...
#
# Now, learn how to [prepare data for training](https://colab.research.google.com/github/neuronets/nobrainer-book/blob/master/docs/nobrainer-guides/notebooks/02-preparing_training_data.py)
